# Case Study #1: Netflix - Data Exploration and Visualization

## Question

Q1. Business Case: Netflix - Data Exploration and Visualization
...
1. Assume that you are presenting your findings to business executives who have only a basic understanding of data science. Avoid unnecessary technical jargon.
1. Start by exploring a few questions:
...
1. Observations on the shape of data, data types of all the attributes, conversion of categorical attributes to 'category' (If required), missing value detection, statistical summary **(10 Points)**
1. Non-Graphical Analysis: Value counts and unique attributes **(10 Points)**
1. Visual Analysis - Univariate, Bivariate after pre-processing of the data
...
1. Business Insights **(10 Points)** - Should include patterns observed in the data along with what you can infer from it.
...
1. Convert your jupyter notebook into PDF (Save as PDF using Chrome browser’s Print command), upload it in your Google Drive (set the permission to allow public access), and paste that link in the text editor.
1. Alternatively, you can directly submit your PDF on the portal.
1. Optionally, you may add images/graphs in the text editor by taking screenshots or saving matplotlib graphs using `plt.savefig(...)`.
1. After submitting, you will not be allowed to edit your submission.

[1]: https://d2beiqkhq929f0.cloudfront.net/public_assets/assets/000/000/940/original/netflix.csv
