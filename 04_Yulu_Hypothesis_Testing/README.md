# Case Study #4: Yulu - Hypothesis Testing
...
1. It is understandable that you might struggle with getting started on this. Just brainstorm, discuss with peers, or get help from TAs.
1. There is no right or wrong answer. We have to become comfortable with dealing with uncertainty in business. This is exactly the skill we want to develop.
...
2. Hypothesis Testing (30 Points):
   ...
   - **ANNOVA** to check if No. of cycles rented is similar or different in different (10 points)
     1. weather
     2. season
...
[1]: https://d2beiqkhq929f0.cloudfront.net/public_assets/assets/000/001/428/original/bike_sharing.csv?1642089089
